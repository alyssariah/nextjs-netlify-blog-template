  ...
  return (
    <div>
      ...
      <main className="w-[100%] flex flex-col items-center">
        ...
        <div className="w-[100%] h-[70vh] md:h-[90vh] 2xl:h-[70vh] mt-8 relative flex justify-center items-center">
          <div className="z-[20] flex flex-col justify-center mb-8 px-4">
